...
import com.example.tokopediatugas7.R
import com.example.tokopediatugas7.databinding.ChildItemBinding
import com.example.tokopediatugas7.databinding.Content1Binding
import com.example.tokopediatugas7.databinding.Content4Binding
...
class MainAdapter(
    ...
    inner class SectionItemViewHolder(private val binding: Content4Binding) : RecyclerView.ViewHolder(binding.root){
        ...
        fun bindSectionView(content4: Content4){
            binding.Text4.text = content4.text
        }
